...
@Component
public class WorksplitAccessTokenConverter extends JwtAccessTokenConverter implements AccessTokenConverter{

    private boolean includeGrantType;

    private UserAuthenticationConverter userTokenConverter = new WorksplitUserAuthenticationConverter();
    ...
    public OAuth2Authentication extractAuthentication(Map<String, ?> map) {
        ...
        if (user == null && map.containsKey(AUTHORITIES)) {
            ...
            authorities = AuthorityUtils.createAuthorityList(scope.toArray(new String[scope.size()]));
        }
